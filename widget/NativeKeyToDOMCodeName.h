...
//CODE_MAP_ANDROID(XTop,                  0x0258)
//CODE_MAP_ANDROID(KeyTriStateTop,          0x0258)// opx ,side of body, not on keyboard
//CODE_MAP_ANDROID(KeyTriStateMid,          0x0259)// opx ,side of body, not on keyboard
//CODE_MAP_ANDROID(KeyTriStateBottom,       0x025A)//opx , side of body, not on keyboard
