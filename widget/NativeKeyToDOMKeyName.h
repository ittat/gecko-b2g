...
//XTop
KEY_MAP_ANDROID (XTop, AKEYCODE_XTOP)
KEY_MAP_ANDROID (XMid, AKEYCODE_XMID)
KEY_MAP_ANDROID (XBottom, AKEYCODE_XBOTTOM)
//KEY_MAP_ANDROID (TriStateTop, AKEYCODE_TRI_STATE_TOP)
//KEY_MAP_ANDROID (KeyTriStateMid, AKEYCODE_KEY_TRI_STATE_MID)
//KEY_MAP_ANDROID (KeyTriStateBottom, AKEYCODE_KEY_TRI_STATE_BOTTOM)
