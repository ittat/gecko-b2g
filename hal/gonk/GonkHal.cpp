...
//<20% red
#ifndef BATTERY_LOW_ARGB
#define BATTERY_LOW_ARGB 0x00FF0000
#endif
//20% Orange #FFA500
#ifndef BATTERY_CHARGING_SED_ARGB
#define BATTERY_CHARGING_SED_ARGB 0x00FFA500
#endif
//50% #FFFF00 黄色
#ifndef BATTERY_CHARGING_MID_ARGB
#define BATTERY_CHARGING__MID_ARGB 0x00FFFF00
#endif
//70% #00FFFF 蓝色
#ifndef BATTERY_CHARGING_TRI_ARGB
#define BATTERY_CHARGING_TRI_ARGB 0x0000FFFF
#endif
//90%< green
...
#define LOG(args...)  __android_log_print(ANDROID_LOG_INFO, "BatteryHal" , ## args)
...
public:
  NS_IMETHOD Run()
  {
    ...
    if (info.charging() && (info.level() >= 0.9)) {
      // Charging and battery full.
      color = BATTERY_FULL_ARGB;
    } else if (info.charging() && (info.level() >= 0.7)) {
      // Charging but not full.
      color = BATTERY_CHARGING_TRI_ARGB;
    }else if (info.charging() && (info.level() >= 0.5)) {
      // Charging but not full.
      color = BATTERY_CHARGING__MID_ARGB;
    }else if (info.charging() && (info.level() >= 0.2)) {
      // Charging but not full.
      color = BATTERY_CHARGING_SED_ARGB;
    }else if (info.level() < 0.2) {

      color = BATTERY_LOW_ARGB;
  ...
  //  LOG("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
    LOG("BatteryHal NS_IMETHOD Run");
    LOG("level:%f", info.level());
...
public:
  ...
  //  LOG("$$$$$$$$$$$$$$$$$$$$$$$$$Notify$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
    ...
    LOG("$$$$$$$$$$$$$$$$$$$$$$$$$subsystem:%s" , subsystem);
    LOG("$$$$$$$$$$$$$$$$$$$$$$$$$devpath:%s" , devpath);
...
RegisterBatteryObserverIOThread()
{
 ...
 //   LOG("$$$$$$$$$$$$$$$$$$$$$$$$$RegisterBatteryObserverIOThread()$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
...
{
 //   LOG("$$$$$$$$$$$$$$$$$$$$$$$$$EnableBatteryNotifications()$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
...
{
 //   LOG("$$$$$$$$$$$$$$$UnregisterBatteryObserverIOThread()$$$$$$$$$$$$$$$$$$$$$$$");
  MOZ_ASSERT(MessageLoop::current() == XRE_GetIOMessageLoop());
  MOZ_ASSERT(sBatteryObserver);
...
{
 //   LOG("$$$$$$$$$$$$$DisableBatteryNotifications()$$$$$$$$$$$$$$$$$$$$$$$$$$");
  XRE_GetIOMessageLoop()->PostTask(
      FROM_HERE,
...
{
 //   LOG("$$$$$$$$$$$$$$$$$$$$$$$$GetCurrentBatteryInformation$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
  int charge;
