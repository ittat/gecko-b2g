...
//DEFINE_KEYNAME_WITH_SAME_NAME(TriStateTop)
//DEFINE_KEYNAME_WITH_SAME_NAME(KeyTriStateMid)
//DEFINE_KEYNAME_WITH_SAME_NAME(KeyTriStateBottom)
DEFINE_KEYNAME_WITH_SAME_NAME(XTop)
DEFINE_KEYNAME_WITH_SAME_NAME(XMid)
DEFINE_KEYNAME_WITH_SAME_NAME(XBottom)
