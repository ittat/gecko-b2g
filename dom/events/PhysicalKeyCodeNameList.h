...
//DEFINE_PHYSICAL_KEY_CODE_NAME_WITH_SAME_NAME(XTop)
//DEFINE_PHYSICAL_KEY_CODE_NAME_WITH_SAME_NAME(KeyTriStateTop)
//DEFINE_PHYSICAL_KEY_CODE_NAME_WITH_SAME_NAME(KeyTriStateMid)
//DEFINE_PHYSICAL_KEY_CODE_NAME_WITH_SAME_NAME(KeyTriStateBottom)
