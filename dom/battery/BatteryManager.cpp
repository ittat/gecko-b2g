...
#define LOG(args...)  __android_log_print(ANDROID_LOG_INFO, "BatteryManager" , ## args)
#else
#define LOG(args...)
#endif
...
{
 //   LOG("$$$$$$$$$$$$$$$$$$$$$$$$$BatteryManager::DischargingTime() $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
  MOZ_ASSERT(NS_IsMainThread());
  // For testing, unable to report the battery status information
  if (Preferences::GetBool("dom.battery.test.default", false)) {
...
{
  //  LOG("$$$$$$$$$$$$$$$$$$$$$$$$$BatteryManager::ChargingTime() $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
  MOZ_ASSERT(NS_IsMainThread());
  // For testing, unable to report the battery status information
  if (Preferences::GetBool("dom.battery.test.default", false)) {
    return 0.0;
...
{
 //   LOG("$$$$$$$$$$$$$$$$$$$$$$$$$BatteryManager::UpdateFromBatteryInfo$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
