...
//ittat
    let isSofeMode = Services.prefs.getCharPref('b2g.safe_mode');
    if (isSofeMode == "yes") {
       homeURL = "about:config";
    }
//end
  ...
  debug('!!!!!!!!!!!!!!!!!!!!evt!!!!!!!!!!!!!!!!!!!!!' + evt);
    if (evt.key == undefined) {
       //    debug('!!!!!!!!!!!!!!!!!!!!evt.key == undefined!!!!!!!!!!!!!!!!!!!!!');
           
    } else {
     //   debug('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!handleEvent to get key: ' + evt.keyCode);
     //   debug('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!handleEvent to get key: ' + evt.type);
    }
...
//ittat
      case 'test':
        Services.prefs.setBoolPref('network.proxy.pac_generator', false);
        setTimeout(function() {
         Services.prefs.setIntPref("network.proxy.type", 1);
        debug('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!test-gecko:' +  prefa.getIntPref("network.proxy.type"));
        }, 300);
        setTimeout(function() {
        ...
        setTimeout(function() {
         Services.prefs.setIntPref("network.proxy.type", 3);
        debug('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!test-gecko:' +  prefa.getIntPref("network.proxy.type"));
        }, 300);
        setTimeout(function() {
        ...
        setTimeout(function() {
         Services.prefs.setIntPref("network.proxy.type", 6);
        debug('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!test-gecko:' +  prefa.getIntPref("network.proxy.type"));
        }, 300);
        setTimeout(function() {
         Services.prefs.setIntPref("network.proxy.type", 7);
        debug('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!test-gecko:' +  prefa.getIntPref("network.proxy.type"));
        }, 300);
        setTimeout(function() {
         Services.prefs.setIntPref("network.proxy.type", 6);
